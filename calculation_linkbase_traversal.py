...
#
# Example invocation:
#   raptorxmlxbrl valxbrl --script=calculation_linkbase_traversal.py nanonull.xbrl
...
def print_calculation_tree(dts, linkrole):
    ...
    # Get the effective network of calculation relationships for the given linkrole URI
