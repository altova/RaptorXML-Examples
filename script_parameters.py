...
#
# Example invocation:
#   raptorxml valxml-withxsd --streaming=false --script=script_parameters.py --script-param="mystring:Lorem ipsum" --script-param="myint:99" --script-param="foo:bar" ExpReport.xml
